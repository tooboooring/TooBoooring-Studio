...
export class Timeline {
    ...
    resizeAndRedraw() {
        ...
        this.segmentsCanvas.width = this.segmentsCanvas.offsetWidth;
        this.segmentsCanvas.height = this.segmentsCanvas.offsetHeight;

        // Now, redraw everything with the new sizes
        if (this.duration > 0) {
            ...
            this.draw(this.segments, this.duration, waveformData);
        }
    }
