// TooBoooringStudio headless render CLI.
//
// Renders a project from a workspace folder to a video file, driving the real
// render engine inside headless Chrome via the window.tooboooring harness.
//
// Usage:
...
async function main() {
  ...
  try {
    ...
    await page.exposeBinding('__tooboooringProgress', (_src, progress) => {
      if (args.json) return
