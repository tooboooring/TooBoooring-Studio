...
export default defineConfig({
  ...
  build: {
    ...
    rollupOptions: {
      ...
      // harness (headless.html), a UI-less entry that exposes window.tooboooring
      ...
      output: {
        manualChunks: (id) => {
          ...
          const isAppShellComponent =
            normalizedId.endsWith('/src/components/brand/tooboooring-logo.tsx') ||
