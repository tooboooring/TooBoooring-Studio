...
export const useGizmoStore = create<GizmoStoreState & GizmoStoreActions>((set, get) => ({
  // State
  activeGizmo: null,
  ...
  setCanvasBackgroundPreview: (color) => set({ canvasBackgroundPreview: color }),

  clearCanvasBackgroundPreview: () => set({ canvasBackgroundPreview: null }),
}))
