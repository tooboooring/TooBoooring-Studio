 ...
 *
 * Model: https://huggingface.co/yourusername/RIFE_fp32_timestep (MIT). This is `FuryTMP/RIFE_fp32`
...
const RIFE_MODEL_URL =
  'https://huggingface.co/yourusername/RIFE_fp32_timestep/resolve/main/RIFE_fp32_timestep.onnx'
