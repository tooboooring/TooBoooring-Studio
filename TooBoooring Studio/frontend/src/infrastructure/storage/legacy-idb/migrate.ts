...
/**
 * Migration marker read from `.tooboooring-workspace.json`.
...
/** Marker file kept alongside `.tooboooring-workspace.json` when migration had
 *  per-store errors. Its presence drives a "retry failed items" UI. Cleared
 *  by a successful re-run. */
const MIGRATION_ERRORS_FILENAME = '.tooboooring-migration-errors.json'
