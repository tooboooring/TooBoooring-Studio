# TooBoooringStudio Workspace

This folder is your TooBoooringStudio project workspace - the app's source of truth
...
./
|-- README.md                  <- this file
|-- .tooboooring-workspace.json    <- marker + schema version
...
`project.json` externally works; TooBoooringStudio picks up changes on next load.
