...
export const MARKER_FILENAME = '.tooboooring-workspace.json'
 ...
 * the configured TTL.
 *
 * Naming choice: `.tooboooring-trashed.json` makes the state self-explanatory
 * when browsing the workspace folder externally with a file manager.
 */
const PROJECT_TRASHED_MARKER_FILENAME = '.tooboooring-trashed.json'
...
/** Segments for `projects/{id}/.tooboooring-trashed.json`. */
