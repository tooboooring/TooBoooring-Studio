...
function getMaskCanvasContext(width: number, height: number): CanvasRenderingContext2D | null {
...
export function getMaskRasterScale(feather: number, width: number, height: number): number {
